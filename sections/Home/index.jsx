    ...
    <Section>
      <div className="container">
        ...
        <article className="description">
          ...
          <div className="wrapper">
            ...
            <div className="box">
              ...
              <p className="about">
                아주 간편하게 코인을 구매할 수 있습니다. 거래되고 있는 코인 중 가장 낮은
                가격의 코인을 봇이 자동으로 감지하여 구매할 수 있습니다.
              </p>
            </div>
          </div>
          ...
          <div className="wrapper">
            <div className="box">
              ...
              <p className="about">
                텔레그램 그 자체입니다. 친구들과 메세지를 주고 받으며 코인을 주고 받을 수
                있습니다.
              </p>
            </div>
            <div className="box">
        ...
        <article className="suggest">
          <p>
            한층 진화된 킬로엑스로 <br className="tablet" />톤 블록체인 생태계에 <br />{' '}
            참여해 보세요
          </p>
        </article>
        <UseButton />
